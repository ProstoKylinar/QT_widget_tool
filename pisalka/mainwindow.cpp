...
void MainWindow::set_file_m()
{
    ...
    fileMenu->addAction(tr("&Новое"), this, SLOT(create_new()), QKeySequence(tr("Ctrl+N","File|New")));
    ...
    f1=format->addAction(tr("&Перенос по словам"),this,SLOT(shift_()));
    ...
    helpMenu->addAction(tr("Обо мне и Qt creator"),this,SLOT(about_me()));
    f1->setEnabled(f1_);
